...
export const CharacterPage = () => {
    ...
    return (
        <div className={classNames(style.character, 'opacity')}>
            ...
            <h1 className="title">{isLoading ? <Skeleton inline /> : character?.name}</h1>
            <div className={style.character__subtitle}>Informations</div>
            <Information character={character} isLoading={isLoading} />
        </div>
    );
};
